...
namespace CILantro.Engine.Parser.Extensions
{
    public static class ParseTreeNodeExtensions
    {
        ...
        public static bool IsLdloc0TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Ldloc0Token);
        public static bool IsLdloc1TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Ldloc1Token);
        public static bool IsLdloc2TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Ldloc2Token);
        public static bool IsLdloc3TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Ldloc3Token);
        ...
        public static bool IsRemTokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.RemToken);
        public static bool IsRemunTokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.RemunToken);
        ...
        public static bool IsStloc0TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Stloc0Token);
        public static bool IsStloc1TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Stloc1Token);
        public static bool IsStloc2TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Stloc2Token);
        public static bool IsStloc3TokenNode(this ParseTreeNode node) => node.Term.Name.Equals(GrammarNames.Stloc3Token);
        ...
        public static ParseTreeNode GetChildLdloc0TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsLdloc0TokenNode());
        public static ParseTreeNode GetChildLdloc1TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsLdloc1TokenNode());
        public static ParseTreeNode GetChildLdloc2TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsLdloc2TokenNode());
        public static ParseTreeNode GetChildLdloc3TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsLdloc3TokenNode());
        ...
        public static ParseTreeNode GetChildRemTokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsRemTokenNode());
        public static ParseTreeNode GetChildRemunTokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsRemunTokenNode());
        ...
        public static ParseTreeNode GetChildStloc0TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsStloc0TokenNode());
        public static ParseTreeNode GetChildStloc1TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsStloc1TokenNode());
        public static ParseTreeNode GetChildStloc2TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsStloc2TokenNode());
        public static ParseTreeNode GetChildStloc3TokenNode(this ParseTreeNode node) => node.ChildNodes.FirstOrDefault(cn => cn.IsStloc3TokenNode());
