...
namespace CILantro.Engine.Tests
{
    public class CILantroEngineTests
    {
        ...
        [InlineData("CSF_value_types_sbyte")]
        [InlineData("CSF_value_types_short")]
        [InlineData("CSF_value_types_uint")]
        [InlineData("CSF_value_types_ulong")]
        ...
        [InlineData("CSF_decision_making_if_else_if_else_if_statement")]
